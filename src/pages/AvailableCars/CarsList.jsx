                ...
                <div className="relative text-center overflow-hidden">
                  <div>
                    <div className="relative">
                      ...
                      <Link className="border border-teal-500 py-2 px-4 rounded-sm font-semibold bg-teal-500 active:scale-90 transition-[transform] mt-3 text-sm text-nowrap hidden sm:max-[1100px]:block absolute bottom-1 left-1/2 -translate-x-1/2">RENT IT</Link>
                    </div>
                    <p className="inline-flex items-center gap-1 line-clamp-1 text-xs bg-emerald-900 px-2 py-1 rounded-sm absolute max-[1100px]:top-0 left-0 min-[1100px]:bottom-2 min-[1100px]:left-2 font-medium"><FaLocationDot />{car.location}</p>

                  </div>

                  <Link className="border border-teal-500 py-2 px-4 rounded-sm font-semibold hover:bg-teal-500 active:scale-90 transition-[transform] mt-3 text-xs text-nowrap hidden max-sm:inline-block">RENT IT</Link>
                </div>
                ...
                <div className="min-[1100px]:w-8/12 mx-autos">
                  ...
                  <div className="flex justify-between px-4">
                    ...
                    <div className="max-[1100px]:hidden mx-4">
                      ...
                      <Link className="border border-teal-500 py-2 px-4 rounded-sm font-semibold mt-4 hover:bg-teal-500 active:scale-90 transition-[transform] text-nowrap block">RENT IT</Link>
                    </div>
